...
class TestTimeSeriesCleaner:
    ...
    def test_ordena_por_serie_y_fecha(self, cleaner, sample_df):
        result = cleaner.clean(sample_df)
    ...
    def test_detect_temporal_gaps(self, cleaner):
        df = pd.DataFrame({
    ...
    def test_sin_gaps(self, cleaner):
        df = pd.DataFrame({
    ...
    def test_remove_outliers_by_range(self, cleaner):
        df = pd.DataFrame({
